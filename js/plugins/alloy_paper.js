...
(function(root, factory) {
        ...
        "renderObj": function(ctx, o) {
            ...
            if (mmyCanvas) {
                ...
                if (rect.length === 4) {
                    ...
                    ctx.drawImage(o.img, rect[0], rect[1], rect[2], rect[3], rect[4], rect[5], rect[6], rect[7]);
                }
    ...
    AlloyPaper.Bitmap = AlloyPaper.DisplayObject.extend({
        ...
        "_initWithSrc": function(img, rect) {
            console.log(1);
        ...
        "_init": function(img, rect) {
            if (!img) return;
            this.img = img;
            this.img.crossOrigin = "Anonymous";
            this.width = img.width;
            this.height = img.height;
            this.rect = rect || [0, 0, img.width, img.height];
        },
    ...
    AlloyPaper.Stage = AlloyPaper.Container.extend({
        ...
        "_correction": function(pageX, pageY) {
            ...
            return {
                x: this.width * x / canvasWidth,
                y: this.height * y / canvasHeight
            };
        }
    });
