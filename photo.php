    ...
    <div class="pop">
        ...
        <section class="pop-rule">
            <div class="pop-rule_box">
                ...
                <p class="flex flex-justify_center flex-align_center"><i class="icons icon-checked"></i><span>同意迪卡侬使用上传照片用于商业宣传 (如同意请勾选)</span></p>
                ...
                <div class="rule-pic"><img src="images/pic-prize1.jpg" alt="一等奖：价值5000元SEAISEE水下魅力写真拍摄一组" /></div>
